...
\setmonofont{Courier New}
    ...
    % Document parameters
    % Document title
    \title{Приложение 1. Преобразование размерных величин}
...
\subsection{\texorpdfstring{Объемный расход
...
\subsection{\texorpdfstring{Проницаемость
...
\subsection{\texorpdfstring{Вязкость
...
\subsection{\texorpdfstring{Давление
...
\subsection{\texorpdfstring{Расстояние
